...
-- Navigate buffers with [b
vim.keymap.set('n', '[b', '<cmd>bp<CR>', { desc = 'Go to [P]revious buffer' })
vim.keymap.set('n', ']b', '<cmd>bn<CR>', { desc = 'Go to [N]ext buffer' })
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- vim.kepmap.set('n', '<leader>sG', builtin.git_status, { desc = '[S]earch [G]it Changes' })
